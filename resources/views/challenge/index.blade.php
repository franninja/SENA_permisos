    ...
    <tbody>
      ...
      <tr>
        ...
        <div class="modal fade" id="modalState_{{$challenge->id}}" tabindex="-1" role="dialog"
          aria-labelledby="exampleModalLabel_{{$challenge->id}}" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel_{{$challenge->id}}">Cambiar Estado del Desafio</h5>
              ...
              <div class="modal-footer">
                ...
                <form method="POST" action="{{ route('challenge.changeStatus', $challenge->id) }}">
                  @csrf
